package com.cs442project.appmonitor.loader;
...
import com.cs442project.appmonitor.observer.InstalledAppsObserver;
import com.cs442project.appmonitor.observer.SystemLocaleObserver;
...
public class AppListLoader extends AsyncTaskLoader<List<AppEntry>> {
  ...
  public List<AppEntry> loadInBackground() {
    ...
    for (int i = 0; i < apps.size(); i++) {
      ...
      System.out.println("LOOK HERE ---> "+entry);
    }
