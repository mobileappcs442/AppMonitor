...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        //BUTTON ON CLICK LISTENER WILL START THE MAIN ACTIVITY
        Button button_fb = (Button) findViewById(R.id.button2);
        button_fb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                startActivity(new Intent(this, FacebookToday.class));
            }
        });
        */
